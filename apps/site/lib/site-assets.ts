...
export const siteAssetSlots: SiteAssetSlot[] = [
  {
    ...
    description:
      'A high-quality EveryBible app screenshot or composite used as the main hero visual.',
  ...
  },
  {
    ...
    description:
      'Optional secondary screenshot for layered composition or crossfade support in the hero.',
  ...
  },
  {
    ...
    description:
      'A non-generic atmospheric treatment that supports the hero without fighting the app imagery.',
    requiredForPhase2: true,
  },
  {
    ...
    description:
      'A set of app screenshots used below the hero to establish credibility and product depth.',
    requiredForPhase2: true,
  },
];
