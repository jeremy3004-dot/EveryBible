export const pt = {
  "readingActivity": {
    ...
    "legendProgress": "{{read}} de {{elapsed}} dias",
    "legendRead": "Lido",
    "legendToday": "Hoje",
    "listening": "Escuta",
  ...
  "home": {
    ...
    "ledgerThisMonth": "{{month}} · {{active}} de {{total}} dias",
    "ledgerThisWeek": "Esta semana · {{active}} de {{total}} dias",
  ...
  "onboarding": {
    ...
    "countrySearchPlaceholderCount": "Pesquisar entre {{total}} nações",
    "noNationsFound": "Nenhuma nação corresponde ainda",
  ...
  "more": {
    ...
    "translationsValue": "{{abbreviation}} · {{count}} off-line",
    "sync": {
  ...
  "readingPlans": {
    ...
    "readMissedSummary": "{{read}} lidos · {{missed}} perdidos",
    "readSummary": "{{read}} lidos",
  ...
  "plans": {
    "rhythmComposer": {
      ...
      "prayerAndScripture": "Oração e Escritura",
      ...
      "emptyBody": "Tente uma tradição mais ampla ou um horário diferente do dia.",
