export const tr = {
  ...
  "onboarding": {
    "allNations": "Tüm uluslar",
    "continueWithNation": "{{name}} ile devam et",
    "countryLanguageCount_one": "{{count}} dil",
    "countryLanguageCount_other": "{{count}} dil",
    "countrySearchPlaceholderCount": "{{total}} ulus arasında ara",
    "noNationsFound": "Henüz eşleşen ulus yok",
    "noNationsFoundBody": "Başka bir yazım deneyin ya da İngilizce veya yerel yazıyla arayın.",
  ...
  "audio": {
    ...
    "chooseBackgroundLayer": "Çevrimdışı kutsal metin dinlemek için yerleşik bir arka plan katmanı seçin.",
  ...
  "more": {
    ...
    "groupApp": "Uygulama",
    "groupContent": "İçerik",
    "highlightsAndNotes": "Vurgulamalar ve notlar",
    ...
    "sync": {
      ...
      "relativeNow": "az önce",
      "signInToSync": "Senkronlamak için oturum aç",
  ...
  "auth": {
    ...
    "serviceUnavailable": "EveryBible sunucuya ulaşamadı. Lütfen bir süre sonra tekrar deneyin.",
    ...
    "resetPasswordTitle": "Yeni bir parola belirle",
    ...
    "resetLinkDifferentAccount": "Bu sıfırlama bağlantısı başka bir hesaba ait. Önce bu hesaptan çıkış yapın, sonra bağlantıyı yeniden açın.",
  ...
  "learn": {
    ...
    "noPassageText": "Kullanılabilir pasaj metni yok",
    "listenToStoryAgain": "Hikâyeyi Tekrar Dinle",
    "shareApp": "Uygulamayı Paylaş",
  },
  "plans": {
    "rhythmComposer": {
      "subtitle": "Özenle seçilmiş ritim kütüphanesi, tek dokunuşla ekleyebileceğiniz yirmi tarihi başlangıç noktası.",
      "heroEyebrow": "Tarihi ritimler",
      "heroTitle": "Boş bir formdan değil, gerçek bir gelenekten başlayın",
      "heroBody": "Katolik, Anglikan, Ortodoks, Benedikten, Lutheran, Püriten ve Taize esinli ritimler, sabah, öğle, akşam ya da herhangi bir zaman için tekrarlanabilir pasajlar hâline getirilmiştir.",
      "presetCount": "{{count}} hazır ayar",
      "prayerAndScripture": "Dua ve Kutsal Yazı",
