export const en = {
  ...
  home: {
    ...
    ledgerBooksFinished: 'Books finished',
    ledgerBooksFinishedCaption: 'Cover to cover',
    ledgerNoBooksFinished: 'None yet',
    ledgerSince_one: 'Since {{date}} · {{count}} chapter',
    ledgerSince_other: 'Since {{date}} · {{count}} chapters',
    ledgerThisWeek: 'This week · {{active}} of {{total}} days',
    ledgerThisMonth_one: '{{month}} · {{active}} of {{count}} day',
