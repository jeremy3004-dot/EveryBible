export const en = {
  ...
  interface: {
    ...
    groupShareMessage:
      'Join my discipleship group "{{name}}" in Every Bible!\n\nJoin code: {{code}}',
    ...
    translationDescriptions: {
      ...
      web: 'Public-domain British-edition text and chapter audio from the Every Bible library',
  ...
  translatorQueue: {
    ...
    pendingCount_one: '{{count}} chapter to review',
    pendingCount_other: '{{count}} chapters to review',
    chapterCounts: '{{down}} to fix \u00b7 {{up}} to confirm',
    openLabel: 'Open {{reference}}',
    notCoveredTitle: "Your passcode doesn't cover {{translation}}",
    notCoveredBody: 'It opens feedback for these translations:',
    notCoveredNone:
      "It doesn't open any translations yet. Ask whoever gave you the passcode to check it.",
  ...
  home: {
    ...
    ledgerSince_one: 'Since {{date}} · {{count}} chapter',
    ledgerSince_other: 'Since {{date}} · {{count}} chapters',
  ...
  onboarding: {
    ...
    countryBody:
      "We'll recommend the Bible languages spoken where you live. You can change this later in Settings.",
    countrySearchPlaceholder: 'Search for your nation',
    countrySearchPlaceholderCount: 'Search {{total}} nations',
    countryLanguageCount_one: '{{count}} language',
    countryLanguageCount_other: '{{count}} languages',
    stepEyebrow: 'Step {{step}} of {{total}}',
    suggestedFromDevice: 'Suggested from your device',
    suggestedBadge: 'Suggested',
    allNations: 'All nations',
    searchResults: 'Results',
    continueWithNation: 'Continue with {{name}}',
    searchAboveHint: 'Not here? Search above',
    noNationsFound: 'No nation matches yet',
    noNationsFoundBody: 'Try another spelling, or search in English or the local script.',
  ...
  bible: {
    ...
    bookComingSoon: "{{book}} isn't available as text or audio in this translation yet.",
    ...
    chapterFeedbackTitle: 'Review this passage',
    chapterFeedbackBody:
      'Does this passage look accurate? Choose Accurate or Needs work, then add an optional note.',
    chapterFeedbackThumbsUp: 'Accurate',
    chapterFeedbackThumbsDown: 'Needs work',
    chapterFeedbackPlaceholder: 'Optional note about accuracy',
    chapterFeedbackSelectionHint: 'Choose Accurate or Needs work to add an optional note.',
    chapterFeedbackSubmit: 'Send review',
    ...
    translatorReviewUnread: 'Needs decision',
    ...
    returnToPlanHint: 'Returns to the plan detail screen',
    books: {
      GEN: 'Genesis',
      EXO: 'Exodus',
      LEV: 'Leviticus',
  ...
  audio: {
    ...
    readAlongHint: 'Shows the chapter in large text, following the reading',
    readAlongNoTimings: 'This recording has no verse timings, so the text is not highlighted.',
    readAlongOtherTranslation: 'This recording has no text. Showing {{translation}}.',
    readAlongNoText: 'There is no text for this chapter.',
    soundSection: 'Sound',
  ...
  settings: {
    ...
    diagnostics: {
      ...
      exportHeader: 'Every Bible diagnostics report',
  ...
  more: {
    ...
    profile: 'Profile',
    settings: 'Settings',
    about: 'About Every Bible',
    highlightsAndNotes: 'Highlights and notes',
    translations: 'Translations',
    groupAccount: 'Account',
    groupContent: 'Content',
    groupApp: 'App',
    streakValue_one: '{{count}}-day streak',
    streakValue_other: '{{count}}-day streak',
    ...
    sync: {
      ...
      sourceSynced: 'Source: this device · synced {{relative}}',
      relativeNow: 'just now',
      relativeMinutes_one: '{{count}} min ago',
      relativeMinutes_other: '{{count}} min ago',
      relativeHours_one: '{{count}} hr ago',
      relativeHours_other: '{{count}} hr ago',
      relativeDays_one: '{{count}} d ago',
      relativeDays_other: '{{count}} d ago',
    },
  },
  readingActivity: {
    eyebrow: 'More · Reading activity',
    ...
    legendRead: 'Read',
    legendToday: 'Today',
    legendProgress_one: '{{read}} of {{count}} day',
    legendProgress_other: '{{read}} of {{count}} days',
    dayChapters_one: '{{count}} chapter · {{books}}',
  ...
  auth: {
    ...
    signInSubtitle:
      'Sign in to keep your reading, highlights and plans in step across your devices.',
    signUpSubtitle:
      'Create an account to keep your reading, highlights and plans in step across your devices.',
    orWithEmail: 'Or with email',
    tagline: 'Free forever · No ads · Every language',
    email: 'Email',
    ...
    serviceUnavailable: "Every Bible couldn't reach the server. Please try again in a moment.",
    backendNotConfigured: "Accounts aren't available in this version of Every Bible yet.",
  ...
  harvest: {
    ...
    groupPreviewBadge: 'In progress',
    groupPreviewTitle: 'Study groups',
    groupPreviewBody:
      'Group study is being rebuilt to sync securely across your devices. Until then, your existing groups stay on this device.',
    ...
    groupSyncPending:
      "Syncing groups across devices isn't available yet. Your groups stay on this device.",
    groupSyncSignin: 'Sign in now so your account is ready when synced groups are enabled.',
    groupSyncReady: "Your account is ready for synced groups as soon as they're available.",
  ...
  about: {
    ...
    musicCredit: '“{{title}}” by {{author}} · {{license}}',
  },
  loading: {
  ...
  readingPlans: {
    ...
    noRhythms: 'No rhythms yet',
    noRhythmsBody:
      'Build a repeatable flow by mixing plan progress with custom passages you can reorder anytime.',
    rhythmName: 'Rhythm name',
    rhythmNamePlaceholder: 'Leave blank for an automatic name',
    rhythmItemCount: '{{count}} items',
    ...
    rhythmSlotPrompt: 'Choose the kind of flow you want to build first.',
    rhythmSlotActive: '{{name}} selected',
    selected: 'Selected',
    continueRhythm: 'Continue Rhythm',
    nextUp: 'Next up: {{value}}',
    openRhythm: 'Open Rhythm',
    deleteRhythm: 'Delete Rhythm',
    emptyRhythmPlans: 'Add at least one plan to save this rhythm.',
    emptyRhythmItems: 'Add at least one plan or passage to save this rhythm.',
    alreadyInAnotherRhythm: 'This plan is already in another rhythm.',
    planUnavailableForRhythm: 'Only enrolled, active plans can be added to a rhythm.',
    rhythmSequence: 'Rhythm sequence',
    planItemLabel: 'Plan',
    passageItemLabel: 'Passage',
    addPassage: 'Add scripture passage',
    addPassageToRhythm: 'Add passage to rhythm',
    repeatablePassage: 'Repeatable passage',
    startChapterLabel: 'Start chapter',
    endChapterLabel: 'End chapter',
  ...
  gather: {
    ...
    discoveryBibleStudy: 'Discovery Bible study',
    upNextLesson: 'Up next · Lesson {{lesson}} of {{total}}',
    upNextSubtitle: '{{reference}} · {{parent}}',
    foundationsSummary: '{{foundations}} foundations · {{lessons}} lessons',
    foundationLabel: 'Foundations {{number}}',
    lessonOfCount: 'Lesson {{number}} of {{total}}',
