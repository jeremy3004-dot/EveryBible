export const en = {
  ...
  home: {
    ...
    ledgerChaptersRead: 'Chapters read',
    ledgerChaptersListened: 'Chapters listened',
    ledgerBooksFinished: 'Books finished',
    ledgerBooksFinishedCaption: 'Read or listened, cover to cover',
    ...
    ledgerThisMonth: '{{month}} · {{active}} of {{total}} days',
  ...
  more: {
    ...
    sync: {
      ...
      relativeMinutes: '{{minutes}} min ago',
      relativeHours: '{{hours}} hr ago',
      relativeDays: '{{days}} d ago',
    },
  },
  readingActivity: {
    ...
    legendRead: 'Read',
    legendToday: 'Today',
    legendProgress: '{{read}} of {{elapsed}} days',
  ...
  readingPlans: {
    ...
    rhythmDaySummary: 'Current day: {{day}}',
    rhythmSequence: 'Rhythm sequence',
    rhythmPlanSource: '{{count}} day plan',
    rhythmPassageLabel: '{{count}} chapters',
    planItemLabel: 'Plan',
    ...
    maxChapterHint: '{{count}} chapters available',
