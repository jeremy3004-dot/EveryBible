export const en = {
  ...
  auth: {
    ...
    serviceUnavailable: 'EveryBible could not reach the backend. Please try again in a moment.',
    backendNotConfigured: 'EveryBible is not configured for this build yet.',
