...
const weeklySessionRecipes: WeeklySessionPlanRecipe[] = [
  {
    ...
    // The 20 kathismata are defined in Septuagint (Greek) psalm numbering, which is
    // what the Orthodox Church uses. Our Bible text (BSB) uses Hebrew/Masoretic
    // numbering, which diverges after Psalm 8 (LXX Ps 9 = Hebrew Ps 9+10, so Hebrew
    // numbers run one higher through Ps 147, then realign at 148). These ranges map
    // each kathisma onto the equivalent Hebrew-numbered chapters so the readings show
    // the correct psalms in BSB. All boundaries fall on whole-chapter lines.
    readings: {
      1: { book: 'PSA', chapter_start: 1, chapter_end: 8 },
      2: { book: 'PSA', chapter_start: 9, chapter_end: 17 },
      ...
      6: { book: 'PSA', chapter_start: 38, chapter_end: 46 },
      7: { book: 'PSA', chapter_start: 47, chapter_end: 55 },
      8: { book: 'PSA', chapter_start: 56, chapter_end: 64 },
      9: { book: 'PSA', chapter_start: 65, chapter_end: 70 },
      10: { book: 'PSA', chapter_start: 71, chapter_end: 77 },
      11: { book: 'PSA', chapter_start: 78, chapter_end: 85 },
      12: { book: 'PSA', chapter_start: 86, chapter_end: 91 },
      13: { book: 'PSA', chapter_start: 92, chapter_end: 101 },
      14: { book: 'PSA', chapter_start: 102, chapter_end: 105 },
      15: { book: 'PSA', chapter_start: 106, chapter_end: 109 },
      16: { book: 'PSA', chapter_start: 110, chapter_end: 118 },
      17: { book: 'PSA', chapter_start: 119, chapter_end: null },
      18: { book: 'PSA', chapter_start: 120, chapter_end: 134 },
      19: { book: 'PSA', chapter_start: 135, chapter_end: 143 },
      20: { book: 'PSA', chapter_start: 144, chapter_end: 150 },
    },
    weekday_sessions: {
      sun: { morning: [2, 3] },
