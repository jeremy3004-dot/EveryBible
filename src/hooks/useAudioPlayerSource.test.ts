// Startup import-graph guard: useAudioPlayer is on the startup audio path and must import
// individual stores, not the stores barrel; allowed by docs/testing.md.
