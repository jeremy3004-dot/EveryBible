      ...
      >
        ...
        <View
          style={[
            ...
            styles.accessModalContent,
            { backgroundColor: colors.cardBackground, borderColor: colors.cardBorder },
          ]}
        >
          {/* The keypad dialog is taller than the screen at the largest text sizes; its
              content scrolls inside the card rather than running off both edges. */}
          <ScrollView
            testID="participation-access-scroll"
            style={styles.accessModalScroll}
