...
- Atomic merge RPC for `user_progress.chapters_read` (finding 12). The plan
  half is written as `20260924035821_merge_reading_plan_progress_rpc.sql`.
